...
/* =========================
   Data: বই ও অধ্যায়
   আপনার আপলোড করা তিনটি চ্যাপ্টারের সব লেখা এখানে যোগ করা হয়েছে।
   ========================= */
const books = [
  {
    id: 'budget-bd',
      ...
      // --- অধ্যায় ১ ---
      {
        ...
        pages: [
          ...
          `<h2>রাজস্ব আয়ের উৎস</h2>
           ...
           <h2>বাজেট ঘাটতি</h2>
           <p>যখন সরকারের ব্যয় তার আয়ের চেয়ে বেশি হয়, তখন বাজেট ঘাটতি তৈরি হয়। ঘাটতি পূরণের জন্য সরকার সাধারণত ব্যাংক ঋণ, বিদেশি সাহায্য, বা সঞ্চয়পত্র বিক্রির মাধ্যমে অর্থ সংগ্রহ করে।</p>`
        ]
      },
      ...
      // --- অধ্যায় ২ ---
      {
        ...
        pages: [
          ...
          `<h2>মানবসম্পদ উন্নয়ন</h2>
           <p>শিক্ষা ও দক্ষতা উন্নয়নের মাধ্যমে কর্মসংস্থান বাড়ানো হচ্ছে। দেশের যুব সমাজ এখন বিদেশে কর্মরত হয়ে রেমিট্যান্স পাঠাচ্ছে।</p>
           ...
           <blockquote>“অর্থনৈতিক উন্নয়ন শুধু অবকাঠামো নয়, মানুষের জীবনমানের উন্নয়নই প্রকৃত অগ্রগতি।”</blockquote>`
        ]
      },
      ...
      // --- অধ্যায় ৩ ---
      {
        ...
        pages: [
          ...
          `<h1>টেকসই উন্নয়ন ও ভবিষ্যৎ অর্থনীতি</h1>
           ...
           <h2>সবুজ অর্থনীতি</h2>
           <p>বাংলাদেশ সবুজ অর্থনীতি ও পুনর্নবীকরণযোগ্য শক্তির দিকে মনোযোগ দিচ্ছে। সোলার এনার্জি এবং পরিবেশবান্ধব কৃষি পদ্ধতির মাধ্যমে ভবিষ্যতের অর্থনীতি আরও টেকসই হবে।</p>`,

          // পৃষ্ঠা ২
          `<h2>প্রযুক্তি ও ডিজিটাল অর্থনীতি</h2>
           <p>ডিজিটাল বাংলাদেশ প্রোগ্রামের মাধ্যমে প্রযুক্তি ও আইটি খাতে বিনিয়োগ বাড়ছে। স্মার্ট ব্যাংকিং, অনলাইন বাণিজ্য, এবং ই-গভর্নেন্স দেশকে আরও দক্ষ করছে।</p>
...
function loadBook(bookId){
  ...
  flatPages.push(`
    <div style="display:flex;align-items:center;justify-content:center;height:100%;text-align:center;">
      <div>
        <h1 style="font-size:32px; color:#2c3e50; margin-bottom:10px;">${escapeHtml(book.title)}</h1>
        <p style="color:#666; font-size:18px;">বাংলা অর্থনীতি ব্লগ</p>
        <div style="font-size:50px; margin-top:30px;">📖</div>
      </div>
    </div>
  `);
...
function startAutoScrollCurrentPage(){
  ...
  autoScrollTimer = setInterval(()=>{
    ...
    if(step >= totalSteps){
      ...
      if(autoTurnEnabled) pageFlip.flipNext();
    }
  }, stepMs);
}
...
if(ttsPlay) ttsPlay.addEventListener('click', ()=>{
  if(!currentBook){ alert('বই লোড করা হয়নি।'); return; }
  const pageEl = pageFlip.getPageElement(pageFlip.getCurrentPageIndex());
  if(!pageEl) return;
...
if(downloadBtn) downloadBtn.addEventListener('click', ()=>{
  ...
  popup.document.write('<style>body{font-family:"Noto Serif Bengali", serif;padding:30px} .page{page-break-after:always;margin-bottom:20px;border:1px solid #eee;padding:20px}</style>');
