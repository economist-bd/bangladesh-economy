    ...
    chapters: [
      {
        ...
        pages: [
          `<h1>বাংলাদেশের জাতীয় বাজেট</h1>
           <p>বাংলাদেশের সরকারি বাজেট হলো একটি বার্ষিক অর্থনৈতিক পরিকল্পনা, যেখানে[...]
           <p>এটি দেশের অর্থনীতির দিকনির্দেশনা দেয় এবং সামাজিক, অবকাঠামোগত ও উন্নয়��[...]
        ]
      },
      {
        id: 'types',
        ...
        pages: [
          `<h2>রাজস্ব বাজেট ও উন্নয়ন বাজেট</h2>
           <p>সরকারি বাজেট মূলত দুটি অংশে বিভক্ত — রাজস্ব বাজেট ও উন্নয়ন বাজেট। রাজস[...]
          `<h2>উন্নয়ন বাজেট এবং ADP</h2>
           <p>উন্নয়ন কাজে বরাদ্দ রোড-সেতু, স্বাস্থ্য, শিক্ষা ইত্যাদি ক্ষেত্রে অর্থা�[...]
        ]
      },
      {
        id: 'finance',
        ...
        pages: [
          `<h2>বাজেট ঘাটতি</h2>
           <p>যখন সরকারের ব্যয় তার রাজস্বকে ছাড়িয়ে যায়, তখন ঘাটতি তৈরি হয়। এই ঘাটতি প�[...]
        ]
      },
      {
        id: 'future',
        ...
        pages: [
          `<h2>ভবিষ্যৎ দিকনির্দেশনা</h2>
           <p>ডিজিটাল রাজস্ব প্রশাসন, সবুজ বাজেট, এবং প্রযুক্তিনির্ভর ব্যয় ব্যবস্থ��[...]
        ]
      }
    ]
  }
